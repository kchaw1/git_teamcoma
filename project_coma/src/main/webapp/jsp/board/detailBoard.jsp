...
<body>
	...
	<div id="insertComment">
		<form method="post" action="registcomment.do">
			...
			<table id="comTable" width="70%">
			<tr>
				<td><input type="text" id="cWriter" name="cWriter" value="${user.nickName}" /></td>
				<td><textarea name="cContent" id="cContent" rows="2" cols="60"></textarea></td>
	...
	<span >	
	  <table id="commentList" class="table-striped" width='80%' border='1'>
	  <tr>
	  		...
	  		<c:when test="${cNo eq comment.cNo}">	
				<tr>
				  ...
				  <td colspan="2">
				  	  ...
				  	  <button><a href="detail.do?no=${board.bNo}">취소</a></button>	
				  </td>
				 </tr>
		 	</c:when>
		 	<c:otherwise>
				<tr>
				  ...
				  <td><fmt:formatDate var="cRegDate" value="${comment.cRegDate}" 
				                      pattern="yyyy-MM-dd HH:mm:ss" />
				      <c:out value="${cRegDate}" />
				  </td>
				  <td>
				  	<a href="deletecomment.do?cNo=${comment.cNo}&no=${comment.no}">삭제</a>	
