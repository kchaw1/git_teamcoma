...
.loginBtn {
	box-sizing: border-box;
	position: relative;
	width: 21em; - apply for fixed size margin : 0.2em;
...
<body>
	...
	<div class="grid-wrap">
		...
		<div class="grid">
			...
			<form action="<c:url value="/login/login.do"/>" name="mForm"
				method="post" class="form login" onsubmit="return doAction()">
				...
				<footer class="login__footer"> <input type="submit"
					value="Login">

				<p>
					<span class="icon icon--info">?</span><a style="color: black"
						" href="<c:url value="/jsp/login/passfind.jsp"/>">패스워드 찾기</a>
				</p>
