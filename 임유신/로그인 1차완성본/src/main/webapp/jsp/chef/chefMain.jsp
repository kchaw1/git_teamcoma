...
<nav class="chefMainNav">
  <ul>
    <li><a href="<c:url value="/jsp/chef/classinfo.jsp" />" id="about">클래스 정보</a></li>
    <li><a href="<c:url value="/jsp/chef/chefClassOpen1.jsp" />" id="assess">클래스 개설</a></li>
    <li><a href="<c:url value="/jsp/chef/chefInfoModify.jsp" />" id="barriers">쉐프 개인 정보 수정</a></li>
    <li><a href="<c:url value="/jsp/chef/chefClassModify.jsp" />" id="plan">클래스 개설 정보 수정</a></li>
  </ul>
</nav>
</div>
</div>
