  ...
  <div class="table-wrapper">
	...
	<c:forEach var="b" items="${list}" varStatus="status">
		<tr>
			...
			<td>
			 <c:choose>
			 <c:when test =" ${b.bCategory== '1'} ">
			 	후기
			</c:when>			
			<c:when test =" ${b.bCategory== '2'} ">
			 	AllaboutCook
			</c:when>	
			<c:when test =" ${b.bCategory== '3'} ">
			 	입금확인*
			</c:when>
    ...
    <table id="paginatedTable">
     ...
     <c:forEach var="b" items="${list}" >
		<tr>
			...
			<td>
			<c:choose>
			<c:when test =" ${b.bCategory == 1} ">후기</c:when>			
			<c:when test =" ${b.bCategory == 2} ">AllaboutCook</c:when>	
			<c:when test =" ${b.bCategory == 3} ">입금확인*</c:when>
