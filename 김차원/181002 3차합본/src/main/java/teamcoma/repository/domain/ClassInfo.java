...
public class ClassInfo {
	...
	private String classCareer;
	
	
	public String getClassCareer() {
		return classCareer;
	}
	public void setClassCareer(String classCareer) {
		this.classCareer = classCareer;
	}
	public int getNo() {
		return no;
	}
