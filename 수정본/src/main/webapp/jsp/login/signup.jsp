        ...
        <div class="form">
          <form method="post" action="">
            ...
            <div class="form-group">
              ...
              <label>주소</label>
              <div class="group">
                <input type="text" name="addr"><button class="check">우편검색</button>
              </div>
              <div class="form-group">
              <label>나머지 주소</label>
              <div class="group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
               <div class="submit">
                 <button type="submit" value="찾기" onclick="alert('회원가입이 완료되었습니다. 감사합니다.')"><a href="<c:url value="/main/main.jsp"/>">가입하기</a></button>
