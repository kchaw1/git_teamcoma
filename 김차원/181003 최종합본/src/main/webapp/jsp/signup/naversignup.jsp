...
<body>
   ...
   <div class="cell">
  <div class="content">
          <form method="post" action="<c:url value="/signup/naver-signUp.do"/>" name="mForm" onsubmit="return doAction()" enctype="multipart/form-data" >
    <div class="Add-photo">
      <h2>추가정보입력</h2>
      <div class="Main_picture">
        <div class="picture">
          <span><img src="<c:url value="/jsp/main/KakaoTalk_20181002_110536615.png" />" style="width:100%; height:100%;" /></span>
    ...
    <div class="Tell-us">
      <div class="Main_form">
        <div class="form">
         		<input type="hidden" name="id" value="${member.id}"/>  <!-- 네이버 이메일주소가 아이디 -->               
                <input type="hidden" name="password" value="${member.password}"/> <!-- 초기비밀번호 12345678 -->
                <input type="hidden" name="email" value="${member.id}"/> <!-- 네이버 이메일주소가 이메일 -->
            ...
            <div class="form-group">
              ...
              <div class="group">
                ...
                <input type="hidden" name="nickName" value="${member.id}(naver)"> <!-- 네이버 이메일주소 + (naver)가 닉네임 -->
              
              <div class="form-group">
              <label>주소</label>
              <div class="group" >
                <input type="text" id="addr1" name="mainAddr"><button type="button" id="addr2" onclick="execPostCode()">주소찾기</button>
              </div>
              <div class="form-group">
              <label>나머지 주소</label>
              <div class="group">
                <input type="text" name="detailAddr" id="addr3">
              </div>
            </div>
            <div class="form-group">
              <label>휴대폰 번호</label>
              <div class="group">
                <input type="text" name="phoneNumber" placeholder="'-'빼고 입력해주세요">
              </div>
            </div>
            <div class="form-group">
              <label>가입분류</label>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
               <div class="submit">
                 <button type="submit" value="찾기">입력 완료</button>
...
alert("처음방문하신분은 추가정보를 입력하셔야 합니다.")
...
function doAction(){
    ...
    alert("회원가입을 축하드립니다. 메인화면으로 이동합니다.")
}
</script>
