  ...
  <div class="column">
    ...
    <div class="post-module">
      ...
      <div class="thumbnail">
        ...
        </div><a href="<c:url value="/jsp/chefIntroduce/chefIntroduce.jsp" />"><img src="https://s-i.huffpost.com/gen/1812779/original.jpg"/></a>
      </div>
      <!-- Post Content-->
  ...
  <div class="column">
    ...
    <div class="post-module">
      ...
      <div class="thumbnail">
        ...
        </div><a href="<c:url value="/jsp/chefIntroduce/chefIntroduce.jsp" />"><img src="http://img.asiatoday.co.kr/file/2016y/08m/19d/2016081901001883200104656.jpg"/></a>
      </div>
      <!-- Post Content-->
      <div class="post-content">
        <div class="category">Photos</div>
  ...
  <div class="column">
    ...
    <div class="post-module">
      ...
      <div class="thumbnail">
        ...
        </div><a href="<c:url value="/jsp/chefIntroduce/chefIntroduce.jsp" />"><img src="https://pds.joins.com/news/component/htmlphoto_mmdata/201403/10/htm_20140310114812c030c011.jpg"/></a>
      </div>
      <!-- Post Content-->
      <div class="post-content">
        <div class="category">Photos</div>
  ...
  <div class="column">
    ...
    <div class="post-module">
      ...
      <div class="thumbnail">
        ...
        </div><a href="<c:url value="/jsp/chefIntroduce/chefIntroduce.jsp" />"><img src="http://goos.wiki/images/e/e0/%EB%B9%8C%EB%A6%AC_%ED%97%A4%EB%A7%81%ED%84%B4.png"/></a>
      </div>
      <!-- Post Content-->
      <div class="post-content">
        <div class="category">Photos</div>
