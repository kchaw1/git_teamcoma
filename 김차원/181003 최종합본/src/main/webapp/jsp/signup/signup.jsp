...
<body>
  ...
  <div class="content">
    <div class="Add-photo">
      <h2>회원가입</h2>
          <form method="post" action="<c:url value="/signup/signUp.do"/>" name="mForm" onsubmit="return doAction()" enctype="multipart/form-data" >
      ...
      <div class="Main_form">
        <div class="form">
            <div class="form-group">
              <label>아이디</label>   
              <div class="group">
                <input type="text" id="id" name="id"><span></span><button id="check">중복체크</button><span>
              </div>
            </div>
            <div class="form-group">
              <label>비밀번호</label>
            ...
            <div class="form-group">
              ...
              <label>주소</label>
              <div class="group" >
                <input type="text" id="addr1" name="mainAddr"><button id="addr2" onclick="execPostCode()">주소찾기</button>
              </div>
              <div class="form-group">
              <label>나머지 주소</label>
              <div class="group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
               <div class="submit">
                 <button type="submit" value="찾기">가입하기</button>
