...
<div  id="write">
 ...
 <div class="writeBoard">
    ...
    카테고리  <select name="selectCa" class ="select">
       <option>선택</option>
       <option>------------</option>
  ...
  <textarea id="summernote" name="bContent"><p>Hello Summernote</p></textarea>
  <button class="but">글작성</button><button class="but">글목록</button>
    </div>
   </div>
  </form>
 </div>
