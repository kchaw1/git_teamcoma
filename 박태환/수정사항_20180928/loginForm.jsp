...
<c:import url="/jsp/common/menu.jsp" />
  ...
  <div class="grid">
	...
	<script type="text/javascript">
	  	var naver_id_login = new naver_id_login("pygpWWgtruklf67fHtoQ", "http://localhost:8000/project_coma/jsp/main/main.jsp");
	  	var state = naver_id_login.getUniqState();
	  	naver_id_login.setButton("green", 2,40);
	  	naver_id_login.setDomain("http://localhost:8000/project_coma/jsp/main/main.jsp");
  	...
  	<script>
		var naverLogin = new naver.LoginWithNaverId(
			{
				clientId: "{pygpWWgtruklf67fHtoQ}",
				callbackUrl: "{http://localhost:8000/project_coma/jsp/main/main.jsp}",
				isPopup: false,
				callbackHandle: true
		...
		window.addEventListener('load', function () {
			naverLogin.getLoginStatus(function (status) {
				if (status) {
					...
					window.location.replace("http://" + window.location.hostname + ( (location.port==""||location.port==undefined)?"":":" + location.port) + "/jsp/main/main.jsp");
				} else {
