...
<div class="container">
  ...
  <div class="column">
    ...
    <div class="post-module">
      ...
      <div class="thumbnail">
        ...
        </div><a href="<c:url value='/jsp/chef/chefIntroduce.jsp'/>"><img src="https://i.pinimg.com/originals/d4/a9/dc/d4a9dc54db11065071398dcaa74e40a8.jpg"/></a>
      </div>
      <!-- Post Content-->
      <div class="post-content">
        <div class="category">Photos</div>
        <h1 class="title">최현석</h1>
        <h2 class="sub_title">쉐프 소개글</h2>
      </div>
    </div>
  </div>
  <!-- Normal -->
  <div class="column">
    ...
    <div class="post-module">
      ...
      <div class="post-content">
        <div class="category">Photos</div>
        <h1 class="title">백종원</h1>
        <h2 class="sub_title">쉐프소개글</h2>
      </div>
    </div>
  </div>
  <!-- Normal -->
