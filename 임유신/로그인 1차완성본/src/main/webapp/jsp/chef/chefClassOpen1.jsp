...
<div class="row">  
 ...
 <div class="inputs date col-4">
	 <label for="className">영상 링크</label><br>
    <input type="text" name="className" /><br>
	</div>
...
<div>
  <div class="inputs contact col-6">
    <label for="classAttach">이력첨부</label><br>
    <input type="file" />
  </div>
  
    <div class="inputs contact col-6">
    <label for="classAttach">클래스 사진</label><br>
    <input type="file" />
  </div>
...
<div class="row">  
  <div class="col-12">
    <button class="cssButton" type="submit">
...
<button class="cssButton">위치 수정</button>
</div>
