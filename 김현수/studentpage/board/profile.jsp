  ...
  <section class="about-dev">
    ...
    <div class="profile-card_about">
      ...
      <footer class="profile-card_footer">
        ...
        <p><a class="back-to-profile" href ="<c:url value ="/studentpage/board/editprofile.jsp"/>">프로필 수정하기</a></p>
        <p><a class="back-to-profile" href ="<c:url value ="/studentpage/student/student.jsp"/>">메인으로 가기</a></p>
      </footer>
    </div>
  </section>
</div>
