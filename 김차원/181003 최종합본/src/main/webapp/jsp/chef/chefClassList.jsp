...
<body>
<!-- 이페이지는 목록을 뿌릴때, where절에 회원번호가 들어가야함. 로그인한 유저의 회원번호에 해당하는 목록을 가져와서 뿌려야함 -->
				...
				<div class="column">
					...
					<div class="post-module">
						...
						<div class="thumbnail">
							...
							<a href="<c:url value='/chef/class-modify1.do?classNo=${classInfo.classNo}' />">
							<img src="<c:url value="/common/file/download.do?name=${member.fileSysName}&path=${member.fileSysPath}"/>" style="width:100%; height:100%" /></a>
						</div>
						<!-- Post Content-->
